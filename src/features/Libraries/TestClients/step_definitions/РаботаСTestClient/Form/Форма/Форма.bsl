	...
	Для ккк = 1 По ИменаПараметров.Количество() Цикл
		...
		ИначеЕсли ВРег(ИмяПараметра) = ВРег("Запускаемая обработка") Тогда
			Если ЗначениеЗаполнено(ЗначениеПараметра) Тогда
				ЗначениеПараметра = ПолучитьПутьКФайлуОтносительноКаталогПроекта(ЗначениеПараметра);
...
&НаКлиенте
Функция ПолучитьПутьКФайлуОтносительноКаталогПроекта(ИмяФайлаСРасширением)
	ПутьКФайлу = "";
